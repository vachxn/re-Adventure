...
class VictoryScreen(QWidget):
    """Victory screen with Play Again and Main Menu buttons"""
    ...
    def setup_ui(self):
        ...
        # Victory title
        title = QLabel(self.language_manager.get("game.victory", "VICTORY!"))
        title.setFont(QFont("Arial", 56, QFont.Weight.Bold))
        title.setStyleSheet("color: #ffdd44; margin-bottom: 20px;")
        title.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(title)
        
        # Message
        message = QLabel(self.language_manager.get("game.found_chalice", "You found the Enchanted Chalice!"))
        ...
        # Play Again button
        play_again_btn = QPushButton(self.language_manager.get("game.play_again", "Play Again"))
        play_again_btn.setFont(QFont("Arial", 18, QFont.Weight.Bold))
        play_again_btn.setFixedSize(300, 60)
        ...
        """)
        play_again_btn.clicked.connect(self.play_again_signal.emit)
        layout.addWidget(play_again_btn, alignment=Qt.AlignmentFlag.AlignCenter)
